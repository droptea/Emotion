...
import priv.droptea.emotion.module.pitch.PitchDetectionHandler;
import priv.droptea.emotion.module.pitch.PitchDetectionResult;
import priv.droptea.emotion.module.pitch.PitchProcessor;
import priv.droptea.emotion.module.pitch.PitchProcessor.PitchEstimationAlgorithm;
import priv.droptea.emotion.panel.MicChoosePanel;
import priv.droptea.emotion.panel.PitchDetectionPanel;
import priv.droptea.emotion.panel.SpectrogramPanel;
...
import priv.droptea.emotion.util.io.AudioDispatcherFactory;
...
public class Spectrogram extends JFrame implements PitchDetectionHandler {
	...
	public Spectrogram(String fileName){
		...
		algo = PitchEstimationAlgorithm.CEPSTRUM;
		this.fileName = fileName;
		
		JPanel pitchDetectionPanel = new PitchDetectionPanel(algoChangeListener);
		
		JPanel inputPanel = new MicChoosePanel();
